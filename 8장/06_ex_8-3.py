'''
    ...
    4. student_tuple의 마지막 항복으로 학점을 추가한다.
    이 정보를 바탕으로 딕셔너리를 만들어 출력하시오.
    
    5. 학생의 학점 평균을 출력하시오.
'''

student_tuple = [('202095001','홍길동','010-1234-5678'),('202095002','김길동','010-9481-6853'),('202095003','박길동','010-9876-5432')]
